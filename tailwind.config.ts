	...
	theme: {
		...
		extend: {
			colors: {
				...
				"btn-text": "f2f3f5",
				"btn-text-dark": "",
				"dark-btn-color": "#acbef9",
				"link-color": "#272d6f",
				"link-hover-color": "",
				"dark-link-color": "#7089f6",
				"dark-link-hover-color": "",
			},
			opacity: {
				15: "0.15",
			},
			backgroundImage: {
				"light-gradient":
					"radial-gradient(circle, rgba(252,252,252,1) 26%, rgba(166,199,238,1) 89%) no-repeat center center fixed",
			},
			backgroundSize: {
				"light-gradient-size": "100% 100%",
			},
		},
	},
